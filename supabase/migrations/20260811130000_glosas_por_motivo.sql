-- ═══════════════════════════════════════════════════════════════════════════════
-- Principais motivos de glosa no dashboard de Contas a Receber
--
-- glosas.motivo é texto livre lançado na baixa (sem catálogo/FK — ver migration
-- 20260320_billing_module.sql), então o agrupamento normaliza por
-- lower(btrim(motivo)) para não fragmentar o mesmo motivo escrito com
-- maiúscula/espaço diferentes; o rótulo exibido é o primeiro texto lançado
-- daquele grupo. Mesmo recorte de período que os demais números de glosa do
-- dashboard (v_ids_periodo, igual a kpis.glosado/acatado).
-- ═══════════════════════════════════════════════════════════════════════════════
