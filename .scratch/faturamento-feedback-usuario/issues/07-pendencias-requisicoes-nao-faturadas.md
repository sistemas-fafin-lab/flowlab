...
# Pendências: requisições não faturadas (janela M-1)
...
- Lote apLIS sem NF/RPS (`fatlote.IdRPS` nulo) em status ativos 1, 2, 3, 6, 7 (exclui 4 Recebido, 5 Cancelado, 8 Prejuízo), criado até o fim de M-1 (ex.: em agosto, lotes até 31/07 sem NF são pendência; agosto fica de fora por estar no fluxo normal). Ajustado de M-2 pra M-1 na issue 18 (grilling 24/08).
...
- Em agosto, requisições de jan–jul sem NF aparecem como pendência; agosto não.
