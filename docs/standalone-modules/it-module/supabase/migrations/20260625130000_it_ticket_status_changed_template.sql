-- ============================================================
-- Template de email — Mudança de Status do Chamado (it_ticket_status_changed)
-- Enviado ao solicitante a cada mudança do campo "status" de um chamado.
-- Layout genérico (marca Flow LAB / acento roxo), espelhando it_ticket_update.
-- Variáveis: {{user_name}}, {{ticket_code}}, {{ticket_title}}, {{status_label}}, {{action_url}}
-- ============================================================
...
VALUES (
  ...
  'Seu chamado {{ticket_code}} agora está: {{status_label}}',
  '<!DOCTYPE html>
...
<head>
  ...
  <title>Status do chamado {{ticket_code}} atualizado</title>
  <!--[if mso]>
  <noscript>
    <xml>
          ...
          <tr>
            <td style="padding:40px 40px 32px 40px;">
              ...
              <p style="margin:0 0 28px 0;font-size:15px;color:#6b7280;font-family:''Segoe UI'',Arial,sans-serif;line-height:1.6;">
                O status do seu chamado de suporte foi atualizado. Veja os detalhes abaixo:
              </p>

              <!-- Caixa de destaque do status -->
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;margin-bottom:32px;">
                <tr>
                  <td style="background-color:#faf5ff;border-left:4px solid #8b5cf6;border-radius:0 8px 8px 0;padding:20px 24px;">
                    ...
                    <p style="margin:0 0 14px 0;font-size:18px;font-weight:700;color:#1a1a2e;line-height:1.4;font-family:''Segoe UI'',Arial,sans-serif;">
                      {{status_label}}
                    </p>
                    <p style="margin:0 0 4px 0;font-size:11px;font-weight:600;color:#9ca3af;letter-spacing:1px;text-transform:uppercase;font-family:''Segoe UI'',Arial,sans-serif;">
                      Chamado
                    </p>
