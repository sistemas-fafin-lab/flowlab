...
> Documento técnico de arquitetura - Atualizado em Abril/2026
...
│   │   ├── Layout.tsx                  # Layout principal + sidebar colapsável + animações
│   │   ├── Dashboard.tsx               # Painel de métricas com widgets drag-and-drop
...
│   │   ├── UserManagement.tsx          # Gestão de usuários com busca e filtros
...
- Dashboard interativo com widgets drag-and-drop
- Interface responsiva com animações fluidas (framer-motion)
- Navegação com sidebar colapsável e editor de categorias

### Melhorias Futuras
- [ ] Provider de Email (SMTP)
- [ ] Provider de SMS
- [x] Dashboard de métricas com drag-and-drop (react-grid-layout)
