          ...
          {accessiblePages.map((p, index) => {
            ...
            return (
              <Link
                key={p.path}
                to={p.path}
                className="group p-6 sm:p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 hover:border-blue-400 transition-all duration-300 flex flex-col items-center justify-center text-center hover-lift animate-fade-in-up w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] max-w-xs"
