...
const MODULES = [
  { icon: LayoutDashboard, title: 'Dashboard', description: 'VisÃ£o geral com indicadores, grÃ¡ficos e mÃ©tricas em tempo real do seu negÃ³cio.' },
  { icon: Package, title: 'Estoque', description: 'Controle completo de produtos, lotes, validades e movimentaÃ§Ãµes de inventÃ¡rio.' },
  { icon: FileText, title: 'SolicitaÃ§Ãµes', description: 'Hub centralizado para compras, pagamentos e manutenÃ§Ãµes com fluxo de aprovaÃ§Ã£o.' },
  { icon: Building2, title: 'Fornecedores', description: 'Cadastro e gestÃ£o de fornecedores com histÃ³rico de negociaÃ§Ãµes e avaliaÃ§Ãµes.' },
  { icon: Calculator, title: 'CotaÃ§Ãµes', description: 'Compare propostas de fornecedores lado a lado e aprove com agilidade.' },
  { icon: Receipt, title: 'Faturamento', description: 'EmissÃ£o de notas, contas a receber, glosas e acompanhamento financeiro.' },
  { icon: History, title: 'MovimentaÃ§Ãµes', description: 'Rastreio de entradas, saÃ­das e transferÃªncias de estoque em tempo real.' },
];
...
const Auth: React.FC = () => {
    ...
    try {
      if (formView === 'forgot') {
        ...
        if (error) {
          ...
          alert('InstruÃ§Ãµes de redefiniÃ§Ã£o enviadas para seu email.');
          setFormView('login');
        }
      } else {
        ...
        if (error) {
          ...
          if (error.message.includes('Invalid login credentials')) {
            userFriendlyMessage = formView === 'register'
              ? 'Falha ao criar conta. Verifique se o email Ã© vÃ¡lido e a senha tem pelo menos 6 caracteres.'
              : 'Email ou senha incorretos. Verifique suas credenciais e tente novamente. Se vocÃª nÃ£o tem uma conta, clique em "Cadastre-se".';
            ...
            userFriendlyMessage = 'Por favor, insira um endereÃ§o de email vÃ¡lido.';
          } else if (error.message.includes('User already registered')) {
            userFriendlyMessage = 'Este email jÃ¡ estÃ¡ cadastrado. Tente fazer login ou use outro email.';
          }
  ...
  return (
    <div className="min-h-screen flex w-full">
      {/* ====== LADO ESQUERDO â€” Branding / Visual (hidden no mobile) ====== */}
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950 flex-col items-center justify-center p-10">
        ...
        {/* â”€â”€ Main branding card (expanded) â”€â”€ */}
        <motion.div
        ...
        >
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-blue-200/80 text-base max-w-sm leading-relaxed">
              Sistema de integraÃ§Ã£o operacional do LaboratÃ³rio Lab.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full border border-white/15">
            ...
            <span className="text-blue-100/90 text-xs font-medium">{MODULES.length} mÃ³dulos integrados</span>
          </div>
        </motion.div>

        {/* â”€â”€ Module carousel â”€â”€ */}
        <div
            ...
            <div className="flex gap-2">
              {MODULES.map((_, index) => (
                <button
                  ...
                  aria-label={`Ir para mÃ³dulo ${index + 1}`}
                />
              ))}
            </div>
      ...
      <div className="w-full lg:w-[55%] bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center p-4 sm:p-8 relative overflow-hidden transition-colors duration-300">
        {/* Background orbs visÃ­veis apenas no mobile (onde o lado esquerdo estÃ¡ oculto) */}
        ...
        {/* Card do formulÃ¡rio com Glassmorphism */}
        <motion.div
        ...
        >
          ...
          {/* Mobile logo â€” always visible on mobile */}
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-500 dark:text-gray-300 text-sm">
                    FaÃ§a login para continuar no FlowLab
                  </p>
                </div>
            ...
            {formView === 'register' && (
              ...
              >
                ...
                <div className="mt-5 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 border border-blue-200 dark:border-blue-800 rounded-xl text-slate-700 dark:text-gray-300 text-xs">
                  <strong className="text-blue-800 dark:text-blue-400">Nota:</strong> ApÃ³s criar sua conta, vocÃª poderÃ¡ acessar o nosso sistema de Compras e Estoque.
                </div>
              </motion.div>
            )}
